...
public class Menu {
	...
	public Menu(int menuId, int restaurantId, String itemName, String description, int price, String rating,
	...
	public Menu(int restaurantId, String itemName, String description, int price, String rating,
			boolean isAvailable, String imagePath) {
		super();
		this.restaurantId = restaurantId;
		this.itemName = itemName;
